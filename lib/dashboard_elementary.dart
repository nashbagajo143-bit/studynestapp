...
import 'nav/profile_page.dart';
import 'screen/learning_materials_page.dart';
import 'widgets/review_tasks_page.dart';
import 'widgets/achievements_page.dart';
import 'screen/tasks_screen.dart';

class DashboardElementary extends StatelessWidget {
  const DashboardElementary({super.key});
              ...
              _featureCard(
                ...
                onButtonPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => PastTasksPage(completedTasks: []),
                    ),
                  );
                },
              ),
